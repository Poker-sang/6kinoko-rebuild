...
void legacy_api_contracts(HSQUIRRELVM vm) {
    ...
    auto* child = machine_at(kinoko_sq_create_thread((machine), (32)));
    ...
    require(SQ_SUCCEEDED(kinoko_sq_call((machine), (1), (1), (0))), "deserialized closure call");
