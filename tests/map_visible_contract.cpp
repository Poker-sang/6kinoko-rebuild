...
static kinoko_mcd_chip chip{};
static kinoko_mcd_data data{};
extern "C" kinoko_mcd_data *kinoko_map_query_chip_data(KinokoActLayout *) { return &data; }
extern "C" kinoko_mcd_chip *kinoko_mcd_find_chip(kinoko_mcd_data *,uint32_t) { return &chip; }
...
int main() {
    ...
    auto emit=[&](kinoko_mcd_chip *,Placement *,int index) { output.push_back(index);return true; };
