...
static int test_player_walking(int32_t manager, int32_t vm, int32_t *root,
    ...
    *(int16_t *)(chip.bytes + 34) = 0;
    CHECK(kinoko_host_register_collision_map_abi(PTR(layout)));
        ...
        if(kind==2) {
            ...
            for(int32_t slot=actual_map[52];slot!=actual_map[53];slot+=4) {
                ...
                for(int32_t n=*(int32_t *)(intptr_t)head;n!=head;n=*(int32_t *)(intptr_t)n) {
                    ...
                    CHECK(kinoko_host_register_collision_map_abi(*(int32_t *)(intptr_t)(key+4)));
                }
            }
            char setup[160];
...
static int test_hidden_layer(int32_t vm, int32_t *root) {
    ...
    CHECK(kinoko_execute_act_callback(hidden + 204, 4, NULL) >= 0);
...
static int test_error_value_ownership(int32_t vm) {
    ...
    ((int32_t)(uintptr_t)kinoko_sq_reset_error(((SQVM*)(uintptr_t)(uint32_t)((vm)))));
    error_releases = 0;
    ...
    value[0] = 0x08000080;
    value[1] = PTR(object);
    ((int32_t)(uintptr_t)kinoko_sq_assign_integer(((SQObjectPtr*)(uintptr_t)(uint32_t)((PTR(value)))), (-37)));
    CHECK(value[0] == 0x05000002 && value[1] == -37 && error_releases == 2);
    object[1] = 1;
    value[0] = 0x08000080;
    value[1] = PTR(object);
    ((int32_t)(uintptr_t)kinoko_sq_assign_float(((SQObjectPtr*)(uintptr_t)(uint32_t)((PTR(value)))), (0.75f)));
...
static int test_compiler_receivers(int32_t vm, int32_t *root) {
    ...
    CHECK(kinoko_sq_compile_buffer(((SQVM*)(uintptr_t)(uint32_t)((vm))), (PTR("local =;")), (8), ((int32_t *)"callback source"), (0))==-1);
    CHECK(compile_error_calls==0 && kinoko_sq_get_stack_top(((SQVM*)(uintptr_t)(uint32_t)((vm))))==top);
    CHECK(kinoko_sq_compile_buffer(((SQVM*)(uintptr_t)(uint32_t)((vm))), (PTR("local =;")), (8), ((int32_t *)"callback source"), (1))==-1);
    ...
    CHECK(kinoko_sq_compile_buffer(((SQVM*)(uintptr_t)(uint32_t)((vm))), (PTR("return 42;INVALID")), (10), ((int32_t *)"bounded source"), (0))==0);
    ((int32_t)(uintptr_t)kinoko_sq_push_raw_object(((SQVM*)(uintptr_t)(uint32_t)((vm))), (root[2]), (root[3])));
    ...
    CHECK(kinoko_sq_compile_lexed(((SQVM*)(uintptr_t)(uint32_t)((vm))), (PTR(compiler_test_feed)), ((int32_t *)&feed), (PTR("reader source")), (0))==0);
    ((int32_t)(uintptr_t)kinoko_sq_push_raw_object(((SQVM*)(uintptr_t)(uint32_t)((vm))), (root[2]), (root[3])));
    CHECK(kinoko_sq_call((vm), (1), (1), (0))==0);
...
static int test_act_script_source_registration(int32_t vm, int32_t *root) {
    ...
    CHECK(kinoko_execute_act_callback(PTR(script),4,"test:act-compile-file"));
...
static int test_array_pop_values(int32_t vm, int32_t *root) {
    ...
    CHECK(kinoko_sq_array_pop(((SQVM*)(uintptr_t)(uint32_t)((vm))), (-1), (0)) == 0);
    CHECK(kinoko_sq_get_stack_top(((SQVM*)(uintptr_t)(uint32_t)((vm)))) == top + 1);
    CHECK(*(int32_t *)(intptr_t)(array[2] + 28) == 2);
    CHECK(kinoko_sq_array_pop(((SQVM*)(uintptr_t)(uint32_t)((vm))), (-1), (1)) == 0);
...
static int test_moving_map(int32_t vm, int32_t *root, int32_t manager, const char *directory, int underwater, float start_x, float start_y) {
    ...
    *(int32_t *)(intptr_t)(map_state+40)=PTR(&vector_layout+1);
    ...
    CHECK(kinoko_collision_reset_abi(PTR(g_514300_storage),manager));
    int32_t support=kinoko_host_register_collision_map_abi(moving_layout);
    CHECK(support);
    int32_t init[3];
...
static int test_platform_riding(int32_t vm, int32_t *root, int32_t manager, const char *directory, int green) {
    ...
    *(uint8_t *)(intptr_t)(rider+40)=1;
    CHECK(kinoko_collision_reset_abi(PTR(g_514300_storage),manager));
    if(green) {
        for(int i=0;i<terrain_count;++i) CHECK(kinoko_host_register_collision_map_abi(terrain_layouts[i]));
...
static int test_texture_serialization(int render_target) {
    ...
    for (int compact=0;compact<2;++compact) {
        ...
        if (render_target) {
            ...
            stream.position=0;
            int32_t *factory=(int32_t*)(intptr_t)kinoko_act_make_resource(PTR(&stream),type);
...
int main(int argc, char **argv) {
    ...
    *(int32_t *)(g_kinoko_map_manager_state + 20) = PTR(act_resource);
    CHECK(kinoko_host_find_map_layout_abi(PTR("en")) == PTR(layout));
    CHECK(kinoko_host_find_map_layout_abi(PTR("e")) == 0);
    CHECK(kinoko_host_find_map_layout_abi(PTR("missing")) == 0);
    {
        ...
        *(int32_t *)(g_kinoko_map_manager_state + 16) = PTR(&source_holder);
        kinoko_map_containers_construct((KinokoMapManager*)(g_kinoko_map_manager_state));
        render = kinoko_host_create_map_layer_abi(PTR("en"));
        ...
        CHECK(kinoko_host_create_map_layer_abi(PTR("missing")) == 0);
        ...
        *(float *)((unsigned char *)layer + 148) = 0.0f;
        second = kinoko_host_create_map_layer_abi(PTR("en"));
    ...
    CHECK(kinoko_collision_reset_abi(PTR(g_514300_storage), manager));
    CHECK(kinoko_host_register_collision_map_abi(PTR(layout)) != 0);
    CHECK(kinoko_host_register_collision_map_abi(PTR(layout)) != 0);
    ...
    }
    {
        ...
        proxy = kinoko_host_register_collision_map_abi(PTR(retired_layout));
        CHECK(proxy != 0);
        ...
        int32_t second_proxy = kinoko_host_register_collision_map_abi(PTR(second_layout));
    ...
    (int32_t)(intptr_t)(kinoko_sqplus_object_destroy((void *)(intptr_t)(PTR(closure))));
    {
        ...
        *(uint32_t *)(chips[0].bytes + 16) = 0;
        map_proxy = kinoko_host_register_collision_map_abi(PTR(layout));
        CHECK(map_proxy);
        ...
        *(float *)(intptr_t)(actor + 260) = 5;
        ...
        }
        {
            ...
            CHECK(kinoko_host_register_collision_map_abi(PTR(second_map)));
            *(int16_t *)(chips[0].bytes + 34) = 0;
            position_actor(actor, 144, 100);
    ...
    }
    {
        ...
        kinoko_call_thiscall1((void *)(intptr_t)actor, kinoko_actor_set_chip_flags, 0);
        {
            ...
            *((uint8_t *)query_layer + 140) = 1;
            ...
            CHECK(kinoko_collision_reset_abi(PTR(g_514300_storage), manager));
            CHECK(kinoko_host_register_collision_map_abi(PTR(query_layout)));
