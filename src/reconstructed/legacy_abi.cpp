...
extern "C" void retdec_call_thiscall0(void *object, void *method) {
    call_method<void>(object, method);
}

extern "C" void retdec_call_thiscall1(void *object, void *method, int32_t argument) {
    call_method<void>(object, method, argument);
}

extern "C" int32_t retdec_call_thiscall0_result(void *object, void *method) {
    return call_method<int32_t>(object, method);
}

extern "C" int32_t retdec_call_thiscall1_result(
    void *object, void *method, int32_t argument) {
    return call_method<int32_t>(object, method, argument);
}

extern "C" int32_t retdec_call_thiscall2_result(
    void *object, void *method, int32_t argument1, int32_t argument2) {
    return call_method<int32_t>(object, method, argument1, argument2);
}

extern "C" int32_t retdec_call_thiscall3_result(void *object, void *method,
...
extern "C" int32_t retdec_call_thiscall4_result(void *object, void *method,
