...
int32_t kinoko_sq_pop_array_value(SQVM* machine, int32_t index, int32_t push_value);
SQObjectPtr* kinoko_sq_assign_nullable_float(SQObjectPtr* destination, float value);
SQObjectPtr* kinoko_sq_assign_nullable_integer(SQObjectPtr* destination, int32_t value);
...
int32_t kinoko_sq_compile_text(SQVM* machine, const char* text, int32_t length, const char* name, int32_t raiseerror);
int32_t kinoko_sq_compile_lexed(SQVM* machine, SQLEXREADFUNC reader, void* context, const char* name, int32_t raiseerror);
int32_t kinoko_sq_create_instance(SQVM* machine, int32_t a2);
SQObjectPtr* kinoko_sq_destroy_object(SQObjectPtr* value);
int32_t kinoko_sq_destroy_userdata_entry(SQUserData* object, void* unused, int32_t flags);
...
void* kinoko_sq_raise_object_error(SQVM* machine, SQObjectPtr* error_value);
...
SQVM* kinoko_sq_reset_error_and_return_vm(SQVM* machine);
