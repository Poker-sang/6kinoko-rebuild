...
int32_t __fastcall kinoko_sq_vm_delete(int32_t vm, void *unused, int32_t flags);
int32_t __fastcall kinoko_sq_array_delete(int32_t array, void *unused, int32_t flags);
#ifdef __cplusplus
}
#endif
