...
/* Transfers source runtime ownership (including safe self-assignment). */
KinokoMapManager* kinoko_map_manager_assign(KinokoMapManager *destination, KinokoMapManager *source);
